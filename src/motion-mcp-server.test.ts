...
const MockedMotionClient = MotionClient as jest.MockedClass<typeof MotionClient>;
...
describe('MotionMCPServer', () => {
  ...
  describe('Server initialization', () => {
    it('should create server with correct configuration', () => {
      expect(MockedMotionClient).toHaveBeenCalledWith({ apiKey: 'test-api-key' });
    });
  ...
  describe('Task tools', () => {
    ...
    describe('get_motion_task', () => {
      it('should get task by ID', async () => {
        mockMotionClient.getTask.mockResolvedValue({ ...mockTask, ...mockTaskResponse });
    ...
    describe('create_motion_task', () => {
      ...
      it('should handle validation errors', async () => {
        mockMotionClient.createTask.mockRejectedValue(new Error('Validation failed'));
    ...
    describe('update_motion_task', () => {
      it('should update task', async () => {
        ...
        mockMotionClient.updateTask.mockResolvedValue({ ...mockTask, ...mockTaskResponse });
    ...
    describe('move_motion_task', () => {
      it('should move task to different workspace', async () => {
        ...
        mockMotionClient.moveTask.mockResolvedValue({ ...mockTask, ...mockTaskResponse });
